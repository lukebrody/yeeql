...
export declare class GroupedQueryImpl<S extends TableSchema, Select extends keyof S, GroupBy extends keyof Primitives<S>> extends QueryBase<QueryChange<GroupedQuery<S, Select, GroupBy>>> implements QueryRegistryEntry<S>, GroupedQuery<S, Select, GroupBy> {
