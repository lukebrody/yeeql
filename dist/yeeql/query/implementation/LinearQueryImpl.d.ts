...
export declare class LinearQueryImpl<S extends TableSchema, Select extends keyof S> extends QueryBase<QueryChange<LinearQuery<S, Select, {}>>> implements QueryRegistryEntry<S>, LinearQuery<S, Select, {}> {
