...
import { Query, QueryChange, QueryPrimitiveResult, QueryResult } from '../../../yeeql/query/Query';
import { MinimalQueryChange } from '../../../yeeql/query/QueryBase';
import { Primitives, Row, TableSchema } from '../../../yeeql/table/Schema';
export type GroupedQuery<S extends TableSchema, GroupBy extends keyof Primitives<S>, Q extends Query<unknown, MinimalQueryChange, unknown>> = Query<ReadonlyDefaultMap<Row<Primitives<S>>[GroupBy], QueryResult<Q>>, Readonly<{
    kind: 'addGroup';
