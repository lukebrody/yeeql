...
import { SubqueryChange, SubqueryGenerators, SubqueriesResults, SubqueriesPrimitiveResults } from '../../../yeeql/query/subquery';
...
export type PrimitiveResultRow<S extends TableSchema, Q extends SubqueryGenerators<S>> = Readonly<Row<Primitives<S>>> & Readonly<SubqueriesPrimitiveResults<S, Q>>;
...
export type LinearQuery<S extends TableSchema, Select extends keyof S, Q extends SubqueryGenerators<S>> = Query<ReadonlyArray<ResultRow<S, Select, Q>>, Change<S, Select, Q>, ReadonlyArray<PrimitiveResultRow<S, Q>>>;
